...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Zra Online shop | Home Page</title>
...
<main class="main" id="top">
    ...
    <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="#"> 
        <img class="d-inline-block align-top img-fluid" src="../assets/img/gallery/logo-icon.png" alt="" width="50" /><span class="text-primary fs-4 ps-2">Zra</span></a>
        <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
            <li class="nav-item"><a class="nav-link active" aria-current="page" href="#">Home</a></li>
            <li class="nav-item"><a class="nav-link text-600" href="#product">Product</a></li>
            <li class="nav-item"><a class="nav-link text-600" href="#testimoni">Testimoni</a></li>
        </ul>
        <form class="ps-lg-5">
            <a href="../login.php" class="btn btn-lg btn-outline-primary order-0">Sign Out</a>
        </form>
        </div>
    </div>
    </nav>
    <section class="py-0">
    <div class="bg-holder d-none d-md-block" style="background-image:url(../assets/img/illustrations/belanja.png);background-position:right bottom;background-size:contain;">
    </div>
    <!--/.bg-holder-->
    ...
    <div class="container position-relative">
        ...
        <div class="col-md-7 col-lg-6 text-center text-md-start py-8">
            <h1 class="mb-4 display-1 lh-sm">Online shop<br class="d-block d-lg-none d-xl-block" />paling murah</h1>
                <p class="mt-4 mb-5 fs-1 lh-base">Plan and book your perfect trip with expert advice, 
                    <br class="d-none d-lg-block" />travel tips, destination information and 
                    <br class="d-none d-lg-block" />inspiration from us.
                </p>
            <a class="btn btn-lg btn-primary hover-top" href="#product" role="button">Belanja Sekarang</a>
        </div>
        </div>
    </div>
    </section>
    ...
    <div class="container">
        ...
        <div class="col-md-11 col-lg-4 py-md-3 px-4 px-md-3 px-lg-0 px-xl-2 order-lg-1">
            <h1 class="fw-bold fs-md-3 fs-xl-5">Jajanan yang bikin goodlooking</h1>
    ...
    <div class="container">
        ...
        <div class="col-lg-8 text-center">
            <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5">Sedang Trand</h1>
    ...
    <!-- ============================================-->
    <!-- <section> begin ============================-->
    <section class="pt-5" id="testimoni">

    <div class="container">
        <div class="row flex-center mb-5">
        <div class="col-lg-8 text-center">
            <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5">Testimoni Real</h1>
            <hr class="mx-auto text-primary my-4" style="height:3px; width:70px;" />
        </div>
                ...
                <div class="col-12 col-lg-7 mb-3 mb-md-0">
                    ...
                    <div class="card-body d-flex flex-center flex-column">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid" src="../assets/img/gallery/user-2.png" alt="" /></div>
                        </div>
                        <div class="mt-3 text-center">
                        <h6 class="text-1000 fw-bold">Donquixote Law</h6>
                        <p class="fs--1 fw-normal mb-0">Pelanggan</p>
                        </div>
                    </div>
                    </div>
                </div>
            ...
            <div class="carousel-item" data-bs-interval="2000">
                ...
                <div class="col-12 col-lg-7 mb-3 mb-md-0">
                    ...
                    <div class="card-body d-flex flex-center flex-column">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            <img class="img-fluid" src="../assets/img/gallery/user-1.png" alt="" /></div>
                        </div>
                        <div class="mt-3 text-center">
    ...
    <div class="container">
        ...
        <div class="col-auto mb-4">
            ...
            <li class="list-inline-item me3 me-sm-4"><a class="text-dark text-decoration-none" href="#product">Product</a></li>
            <li class="list-inline-item me3 me-sm-4"><a class="text-dark text-decoration-none" href="#testimoni">Testimoni</a></li>
